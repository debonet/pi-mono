...
| `hideThinkingBlock` | boolean | `false` | Fully hide thinking blocks (no label, no vertical space) |
...
| `messagePaddingX` | number | `1` | Horizontal padding for message text. Set to `0` for clean copy-paste (use terminal padding instead) |
